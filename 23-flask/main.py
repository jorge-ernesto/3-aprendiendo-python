    ...
    if request.method == 'POST':
        ...
        if len(errores) > 0:
            for error in errores:
                flash(errores[error], 'error') # flash con categoría "error" para mostrar mensajes de error. Las categorías más comunes son "success" y "error".
        ...
        flash('Has creado el coche correctamente!!') # flash sin categoría (por defecto "success") para mostrar mensajes de éxito
